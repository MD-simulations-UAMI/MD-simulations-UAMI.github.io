"use strict";
(self["webpackChunkgatsby_starter_henlo"] = self["webpackChunkgatsby_starter_henlo"] || []).push([["vendors-node_modules_gatsby-plugin-image_dist_lazy-hydrate-62277b8c_js"],{

/***/ "./node_modules/gatsby-plugin-image/dist/lazy-hydrate-62277b8c.js":
/*!************************************************************************!*\
  !*** ./node_modules/gatsby-plugin-image/dist/lazy-hydrate-62277b8c.js ***!
  \************************************************************************/
...
/* harmony export */ });
/* harmony import */ var _index_browser_006c3456_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index.browser-006c3456.js */ "./node_modules/gatsby-plugin-image/dist/index.browser-006c3456.js");
...
function h(t, e, o, n, r, a) {
  const i = t.querySelector("[data-main-image]"),
  ...
  function l(t) {
    ...
    const e = t.currentTarget,
      o = new Image();
    o.src = e.currentSrc, o.decode ? o.decode().then(() => {
      b(this, c), null == r || r({
        wasCached: s
      });
    }).catch(t => {
  ...
  return i.addEventListener("load", l), null == n || n({
    wasCached: s
  }), Array.from(i.parentElement.children).forEach(t => {
    const e = t.getAttribute("data-src"),
      o = t.getAttribute("data-srcset");
    e && (t.removeAttribute("data-src"), t.setAttribute("src", e)), o && (t.removeAttribute("data-srcset"), t.setAttribute("srcset", o));
  }), o.add(e), i.complete && l.call(i, {
    currentTarget: i
  }), () => {
    i && i.removeEventListener("load", l);
  };
}
function v(e, o, n, r, a, i, c) {
  if (!(0,_index_browser_006c3456_js__WEBPACK_IMPORTED_MODULE_3__.h)()) {
    let t;
    const b = (g = () => {
        t = h(e, o, n, a, i, c);
      }, "IntersectionObserver" in window ? (d || (d = new IntersectionObserver(t => {
        t.forEach(t => {
          var e;
          t.isIntersecting && (null == (e = u.get(t.target)) || e(), u.delete(t.target));
        });
      }, {
        rootMargin: "4g" !== (null == m ? void 0 : m.effectiveType) || null != m && m.saveData ? "2500px" : "1250px"
      })), function (t) {
        return u.set(t, g), d.observe(t), function () {
          d && t && (u.delete(t), d.unobserve(t));
        };
      }) : function () {
        return g(), function () {};
      }),
      v = b(e);
    var s, l;
    return "objectFit" in document.documentElement.style || (e.dataset.objectFit = null != (s = r.objectFit) ? s : "cover", e.dataset.objectPosition = `${null != (l = r.objectPosition) ? l : "50% 50%"}`, async function (t) {
      "objectFitPolyfill" in window || (await __webpack_require__.e(/*! import() */ "node_modules_objectFitPolyfill_dist_objectFitPolyfill_min_js").then(__webpack_require__.t.bind(__webpack_require__, /*! objectFitPolyfill */ "./node_modules/objectFitPolyfill/dist/objectFitPolyfill.min.js", 23))), window.objectFitPolyfill(t);
    }(e)), () => {
      t && t(), v();
    };
  }
  var g;
  return h(e, o, n, a, i, c);
}
function f(t) {
  let {
      image: d,
    ...
    w = (0,_index_browser_006c3456_js__WEBPACK_IMPORTED_MODULE_3__._)(t, g);
  const {
    width: j,
    height: C,
    layout: E,
  ...
  return v = (0,_index_browser_006c3456_js__WEBPACK_IMPORTED_MODULE_3__.a)({
    objectFit: y,
    objectPosition: f,
    backgroundColor: p
  }, v), (0,react_dom_server__WEBPACK_IMPORTED_MODULE_1__.renderToStaticMarkup)( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_index_browser_006c3456_js__WEBPACK_IMPORTED_MODULE_3__.L, {
    layout: E,
    width: j,
    height: C
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_index_browser_006c3456_js__WEBPACK_IMPORTED_MODULE_3__.P, (0,_index_browser_006c3456_js__WEBPACK_IMPORTED_MODULE_3__.a)({}, (0,_index_browser_006c3456_js__WEBPACK_IMPORTED_MODULE_3__.g)(P, b, E, j, C, L, y, f))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_index_browser_006c3456_js__WEBPACK_IMPORTED_MODULE_3__.M, (0,_index_browser_006c3456_js__WEBPACK_IMPORTED_MODULE_3__.a)({}, w, {
    width: j,
    height: C,
    className: h
  }, (0,_index_browser_006c3456_js__WEBPACK_IMPORTED_MODULE_3__.b)(m, b, F, u, v)))));
}
...
//# sourceMappingURL=vendors-node_modules_gatsby-plugin-image_dist_lazy-hydrate-62277b8c_js.js.map